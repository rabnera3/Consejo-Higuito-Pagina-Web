            ...
            <section className="cih-card">
                <div className="cih-card__body">
                    ...
                    <p className="cih-card__subtitle" style={{ marginBottom: '1.5rem' }}>
                        Gestiona tus proyectos de campo y solicitudes desde aquí.
                    </p>

                    <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                        <Link to="/portal/tecnico" className="btn primary">
                            Panel de Campo
                        </Link>
                        <Link to="/portal/solicitudes" className="btn secondary">
                            Ver Solicitudes
                        </Link>
