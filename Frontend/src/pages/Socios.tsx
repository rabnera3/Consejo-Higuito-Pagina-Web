...
const municipios = [
  {
    nombre: 'Cucuyagua',
    imagen: new URL('../img/municipios/cucuyagua.avif', import.meta.url).href,
    color: 'green',
  ...
  {
    nombre: 'Dulce Nombre',
    imagen: new URL('../img/municipios/dulce_nombre.avif', import.meta.url).href,
    color: 'blue',
  ...
  },
  {
    ...
    imagen: new URL('../img/municipios/dolores.avif', import.meta.url).href,
    color: 'teal',
  ...
  },
  {
    ...
    imagen: new URL('../img/municipios/belen.avif', import.meta.url).href,
    color: 'amber',
  ...
  {
    nombre: 'Veracruz',
    imagen: new URL('../img/municipios/veracruz-copannn-660x330.avif', import.meta.url).href,
    color: 'purple',
  ...
  {
    nombre: 'Corquin',
    imagen: new URL('../img/municipios/corquin.avif', import.meta.url).href,
    color: 'green',
  ...
  },
  {
    ...
    imagen: new URL('../img/municipios/spc.avif', import.meta.url).href,
    color: 'blue',
  ...
  {
    nombre: 'La Unión',
    imagen: new URL('../img/municipios/la union.avif', import.meta.url).href,
    color: 'teal',
  ...
  },
  {
    ...
    imagen: new URL('../img/municipios/san-jose-copan-1024x840.avif', import.meta.url).href,
    color: 'amber',
  ...
  },
  {
    ...
    imagen: new URL('../img/municipios/talgua.avif', import.meta.url).href,
    color: 'purple',
  ...
  },
  {
    ...
    imagen: new URL('../img/municipios/San_Agustin_0414.avif', import.meta.url).href,
    color: 'green',
  ...
  },
  {
    ...
    imagen: new URL('../img/municipios/trinidad.avif', import.meta.url).href,
    color: 'blue',
  ...
  {
    nombre: 'Concepción Copán',
    imagen: new URL('../img/municipios/concepcion.avif', import.meta.url).href,
    color: 'green',
    historia:
      'Su origen se remonta a los antiguos asentamientos chortí de la zona. Fue aldea dependiente de Copán Ruinas y posteriormente de Santa Rosa de Copán hasta inicios del siglo XX, cuando recibió categoría municipal. Se distingue por su producción agrícola y artesanías en madera y cuero.',
  },
  {
    nombre: 'San Juan de Opoa',
    imagen: new URL('../img/municipios/sanjuanopoa.avif', import.meta.url).href,
    color: 'teal',
    historia:
      'Fundado en el siglo XVIII como punto de intercambio entre los valles de Copán y Sensenti. Creció gracias al cultivo de maíz, frijol y tabaco, y conserva festividades religiosas muy arraigadas. Desde su incorporación al CIH participa activamente en proyectos de ordenamiento territorial y fortalecimiento comunitario.',
  },
  {
    nombre: 'Santa Rosa de Copán',
    imagen: new URL('../img/municipios/src.avif', import.meta.url).href,
    color: 'teal',
