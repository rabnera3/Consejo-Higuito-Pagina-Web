...
const municipios = [
  ...
  },
  {
    ...
    imagen: new URL('../img/municipios/dolores.jpg', import.meta.url).href,
    color: 'teal',
  ...
  },
  {
    ...
    imagen: new URL('../img/municipios/belen.jpg', import.meta.url).href,
    color: 'amber',
  ...
  {
    nombre: 'Veracruz',
    imagen: new URL('../img/municipios/veracruz-copannn-660x330.jpg', import.meta.url).href,
    color: 'purple',
  ...
  {
    nombre: 'Corquin',
    imagen: new URL('../img/municipios/corquin.jpg', import.meta.url).href,
    color: 'green',
  ...
  },
  {
    ...
    imagen: new URL('../img/municipios/spc.jpg', import.meta.url).href,
    color: 'blue',
  ...
  {
    nombre: 'La Unión',
    imagen: new URL('../img/municipios/la union.jpg', import.meta.url).href,
    color: 'teal',
  ...
  },
  {
    ...
    imagen: new URL('../img/municipios/san-jose-copan-1024x840.jpg', import.meta.url).href,
    color: 'amber',
  ...
  },
  {
    ...
    imagen: new URL('../img/municipios/talgua.jpg', import.meta.url).href,
    color: 'purple',
  ...
  },
  {
    ...
    imagen: new URL('../img/municipios/San_Agustin_0414.jpg', import.meta.url).href,
    color: 'green',
  ...
  },
  {
    ...
    imagen: new URL('../img/municipios/trinidad.jpg', import.meta.url).href,
    color: 'blue',
  ...
  },
  {
    ...
    imagen: new URL('../img/municipios/concepcion.jpg', import.meta.url).href,
    color: 'green',
    historia:
  ...
  },
  {
    ...
    imagen: new URL('../img/municipios/sanjuanopoa.jpg', import.meta.url).href,
    color: 'teal',
    historia:
  ...
  },
  {
    ...
    imagen: new URL('../img/municipios/src.jpeg', import.meta.url).href,
    color: 'teal',
