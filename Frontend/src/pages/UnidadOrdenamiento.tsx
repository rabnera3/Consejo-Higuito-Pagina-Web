    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 space-y-20">
        ...
        <Stagger className="grid md:grid-cols-2 gap-8">
          ...
          <motion.div variants={itemVariant} className="rounded-2xl overflow-hidden shadow-lg">
            <img
              src="https://images.unsplash.com/photo-1529078155058-5d716f45d604?w=800&h=600&fit=crop"
        ...
        <div>
          ...
          <Stagger className="grid md:grid-cols-2 gap-8">
            <motion.div variants={itemVariant} className="rounded-2xl overflow-hidden shadow-lg group">
              <img
                src="https://images.unsplash.com/photo-1487956382158-bb926046304a?w=800&h=600&fit=crop"
                alt="Taller de ordenamiento territorial"
            ...
            <motion.div variants={itemVariant} className="rounded-2xl overflow-hidden shadow-lg group">
              <img
                src="https://images.unsplash.com/photo-1488229297570-58520851e868?w=800&h=600&fit=crop"
                alt="Reunión comunitaria sobre catastro"
                className="w-full h-[280px] object-cover group-hover:scale-105 transition-transform duration-300"
              />
            </motion.div>
          </Stagger>
